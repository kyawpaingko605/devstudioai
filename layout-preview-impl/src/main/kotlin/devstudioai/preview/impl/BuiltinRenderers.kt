...
import devstudioai.preview.AttrReader
import devstudioai.preview.MeasureSpec
import devstudioai.preview.PaintStyle
import devstudioai.preview.Props
import devstudioai.preview.RCanvas
import devstudioai.preview.RenderContext
import devstudioai.preview.RenderNode
import devstudioai.preview.Renderer
import devstudioai.preview.RendererRegistry
import devstudioai.preview.ResolvedValue
import devstudioai.preview.Size
import devstudioai.preview.ValueFormat
...
internal fun drawBackground(node: RenderNode, canvas: RCanvas, ctx: RenderContext) {
    ...
    (node.props.extras["bgDrawable"] as? devstudioai.android.support.preview.DrawablePreview)?.let {
...
private fun RenderNode.textPaint(ctx: RenderContext): devstudioai.preview.RPaint = ctx.gfx.newPaint().apply {
...
object TextRenderer : Renderer {
    ...
    private fun wrap(node: RenderNode, paint: devstudioai.preview.RPaint, maxWidth: Float, ctx: RenderContext): List<CharSequence> {
    ...
    private fun ellipsizeLine(line: CharSequence, paint: devstudioai.preview.RPaint, maxWidth: Float, ctx: RenderContext): CharSequence {
