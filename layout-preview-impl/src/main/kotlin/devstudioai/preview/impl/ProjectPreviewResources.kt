...
import devstudioai.lang.xml.XmlNode
import devstudioai.lang.xml.XmlTreeParser
...
class ProjectPreviewResources(
    ...
    private fun definition(type: ResourceType, name: String): devstudioai.android.support.resources.ResourceItem? {
