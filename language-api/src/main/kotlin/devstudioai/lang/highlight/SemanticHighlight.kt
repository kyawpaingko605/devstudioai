package devstudioai.lang.highlight
 ...
 * [devstudioai.lang.BackendCapability.SEMANTIC_HIGHLIGHT] and returning a [SemanticHighlightService] from its
 * analyzer (see [devstudioai.lang.SourceAnalyzer.semanticHighlighter]). Adding a language's semantic colors is a
...
interface SemanticHighlightService {
     ...
     * [devstudioai.platform.EngineCancellation] so a higher-priority call (completion) can preempt the pass.
