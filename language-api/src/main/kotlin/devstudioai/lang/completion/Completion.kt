 ...
 * [devstudioai.lang.SourceAnalyzer.completionContributions], and the engine merges them with cross-cutting /
...
sealed interface CaretAction {
     ...
     * `kind = SNIPPET` item — or a postfix-template item (see devstudioai.lang.postfix) — carry full tab-stop
