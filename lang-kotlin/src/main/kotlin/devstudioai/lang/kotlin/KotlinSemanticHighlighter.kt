...
import devstudioai.platform.EngineCancellation
...
class KotlinSemanticHighlighter(
    ...
    private fun classifyMemberSelector(ref: KtNameReferenceExpression, q: KtQualifiedExpression, resolver: KotlinResolver, emit: (org.jetbrains.kotlin.com.intellij.openapi.util.TextRange?, HighlightKind, Set<HighlightModifier>) -> Unit) {
        ...
        if (member.kind == devstudioai.lang.resolve.SymbolKind.FIELD || member.kind == devstudioai.lang.resolve.SymbolKind.ENUM_CONSTANT) {
            val kind = if (member.kind == devstudioai.lang.resolve.SymbolKind.ENUM_CONSTANT) HighlightKind.ENUM_CONSTANT else HighlightKind.PROPERTY
    ...
    private fun deprecationMods(sym: devstudioai.lang.kotlin.symbols.KotlinSymbol): Set<HighlightModifier> =
