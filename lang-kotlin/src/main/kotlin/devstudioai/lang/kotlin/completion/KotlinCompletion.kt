package devstudioai.lang.kotlin.completion

import devstudioai.lang.completion.CompletionContributor
import devstudioai.lang.completion.CompletionItem
...
import devstudioai.lang.completion.CompletionResultSet
import devstudioai.lang.completion.TextEdit
import devstudioai.lang.dom.TextRange
import devstudioai.lang.kotlin.KotlinPerf
import devstudioai.lang.kotlin.parse.KotlinParsedFile
import devstudioai.lang.kotlin.parse.KotlinParserHost
import devstudioai.lang.kotlin.parse.climbTo
import devstudioai.lang.kotlin.parse.identifierPrefixBefore
import devstudioai.lang.kotlin.interp.PreviewConstants
...
class KotlinCompletion(
    ...
    private fun completeInner(document: devstudioai.lang.incremental.DocumentSnapshot, requestedOffset: Int): CompletionResult {
        ...
        runCatching {
            service.syncFocal(document.file.path, original.hashCode()) {
                devstudioai.lang.kotlin.symbols.SourceIndexBuilder.extractFrom(kt, parsed, document.file.path)
            }
        }
