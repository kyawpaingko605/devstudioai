package devstudioai.lang.kotlin.resolve
...
import devstudioai.lang.kotlin.symbols.ImportInfo
...
import devstudioai.lang.kotlin.symbols.TypeRendering
...
class KotlinResolver(
    ...
    private fun extensionInScope(sym: KotlinSymbol): Boolean {
        ...
        if (pkg == fileContext.packageName || devstudioai.lang.kotlin.symbols.DefaultImports.isDefaultImported(pkg)) return true
    ...
    private fun topLevelInScope(sym: KotlinSymbol, ctx: FileContext): Boolean {
        val pkg = sym.packageName ?: sym.declaringClassFqn?.substringBeforeLast('.', "")?.ifEmpty { null } ?: return true
        if (pkg == ctx.packageName || devstudioai.lang.kotlin.symbols.DefaultImports.isDefaultImported(pkg)) return true
    ...
    private fun sourceCtorSymbol(rc: devstudioai.lang.kotlin.symbols.RawCallable, fqn: String): KotlinSymbol = KotlinSymbol(
    ...
    private fun paramSimpleName(t: devstudioai.lang.resolve.TypeRef?): String? =
