...
class KotlinCompletionE2ETest {
    ...
    private fun diagnostics(code: String): List<devstudioai.lang.dom.Diagnostic> = runBlocking {
    ...
    fun unresolvedMemberIsFlagged() {
        ...
        assertTrue(
            diags.any { it.severity == devstudioai.lang.dom.Severity.ERROR && it.message.contains("totallyBogusMethod") },
    ...
    fun unusedLocalIsFlaggedAsWarning() {
        ...
        assertTrue(
            diags.any { it.code == "kt.unusedLocal" && it.severity == devstudioai.lang.dom.Severity.WARNING && it.message.contains("unusedX") },
