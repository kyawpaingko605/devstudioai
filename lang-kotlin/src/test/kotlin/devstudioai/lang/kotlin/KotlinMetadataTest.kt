...
class KotlinMetadataTest {
    ...
    fun decodedSupertypesCarryTheirTypeArguments() {
        ...
        val abstractList = decoded.supertypes.filterIsInstance<devstudioai.lang.kotlin.symbols.KotlinType>()
        ...
        assertTrue(
            (abstractList.typeArguments.first() as? devstudioai.lang.kotlin.symbols.KotlinType)?.isTypeParameter == true,
