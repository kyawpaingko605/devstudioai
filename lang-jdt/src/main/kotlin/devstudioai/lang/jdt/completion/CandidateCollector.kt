package devstudioai.lang.jdt.completion
...
internal object CandidateCollector {
     ...
     */
    fun collect(ctx: AnalyzedContext, index: IndexService?, importOffset: Int, appendCallParens: Boolean, docs: devstudioai.lang.jdt.SourceMethodResolver? = null): List<Candidate> = when (ctx.kind) {
    ...
    private fun members(ctx: AnalyzedContext, appendCallParens: Boolean, docs: devstudioai.lang.jdt.SourceMethodResolver?): List<Candidate> {
    ...
    private fun names(ctx: AnalyzedContext, appendCallParens: Boolean, docs: devstudioai.lang.jdt.SourceMethodResolver?): List<Candidate> {
     ...
     */
    private fun methodCandidate(m: MethodBinding, from: ReferenceBinding?, appendCallParens: Boolean, discouraged: Boolean = false, docs: devstudioai.lang.jdt.SourceMethodResolver? = null): Candidate {
        ...
        return Candidate(
            ...
            documentation = info?.javadocRaw?.let { devstudioai.lang.jdt.JavadocText.clean(it) }?.takeIf { it.isNotEmpty() },
        )
    }
