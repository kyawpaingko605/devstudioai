...
private fun simpleFix(title: String, file: devstudioai.vfs.VirtualFile, edit: DocumentEdit): QuickFix =
    eagerFix(title, file, listOf(edit))

private fun eagerFix(fixTitle: String, file: devstudioai.vfs.VirtualFile, edits: List<DocumentEdit>): QuickFix =
    object : QuickFix {
