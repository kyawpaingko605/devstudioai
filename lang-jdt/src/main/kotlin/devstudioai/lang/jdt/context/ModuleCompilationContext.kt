package devstudioai.lang.jdt.context
...
object ModuleCompilationContext {
     ...
     * drops any dependency whose [devstudioai.model.OrderEntry.variant] qualifier isn't in it (a shared,
...
private class CompilationContextView(
    ...
    override val languageLevel: devstudioai.model.LanguageLevel,
