package devstudioai.plugin.impl

import devstudioai.platform.PluginId
import devstudioai.platform.impl.ExtensionRegistryImpl
import devstudioai.plugin.action.ACTION_GROUP_EP
import devstudioai.plugin.action.ActionContext
import devstudioai.plugin.action.ActionGroup
import devstudioai.plugin.action.ActionPlace
import devstudioai.plugin.action.ActionPlaces
import devstudioai.plugin.action.ActionResult
import devstudioai.plugin.action.SimpleAction
import devstudioai.plugin.action.SimpleGroup
import devstudioai.plugin.action.UI_ACTION_EP
