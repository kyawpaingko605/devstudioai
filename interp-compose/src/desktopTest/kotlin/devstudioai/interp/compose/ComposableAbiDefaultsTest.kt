package devstudioai.interp.compose
...
class ComposableAbiDefaultsTest {
    ...
    fun wrongDeclaredParamCountStillResolvesViaRuntimeComposerIndex() {
        ...
        composeOnce {
            ...
            try {
                ComposableAbi.call(
                    ownerFqn = "devstudioai.interp.compose.ComposableAbiDefaultsTestKt",
                    method = "RecordValues",
    ...
    fun trailingContentLambdaBindsToLastParamWhileOthersDefault() {
        ...
        var ran = false
        val lambda = object : devstudioai.interp.InterpretedLambda {
    ...
    private fun contentProxy(lambda: devstudioai.interp.InterpretedLambda, fi: Class<*>): Any =
    ...
    fun realTransformedComposableIsDetectedByMetadataDecode() {
        ...
        val decoded = devstudioai.lang.kotlin.symbols.KotlinMetadata.decode(bytes, null)
    ...
    fun isComposableCallDetectsTransformedComposableMethods() {
        val facade = "devstudioai.interp.compose.ComposableAbiDefaultsTestKt"
    ...
    fun misdetectedComposableStillRendersViaDispatcher() {
        ...
        val facade = "devstudioai.interp.compose.ComposableAbiDefaultsTestKt"
        val callee = devstudioai.lang.kotlin.interp.ResolvedCallable.Library(
            displayName = "RecordValues", ownerFqn = facade, methodName = "RecordValues",
            paramTypes = listOf(
                devstudioai.lang.kotlin.symbols.KotlinType("kotlin.String"),
                devstudioai.lang.kotlin.symbols.KotlinType("kotlin.Int"),
                devstudioai.lang.kotlin.symbols.KotlinType("kotlin.Boolean"),
            ),
            isStatic = true, isConstructor = false, isInline = false, isComposable = false, // <- mis-detected
        )
        val span = devstudioai.lang.kotlin.interp.SourceSpan(0, 0)
        val call = devstudioai.lang.kotlin.interp.RNode.Call(
            callee, devstudioai.lang.kotlin.interp.DispatchKind.TOP_LEVEL, receiver = null, args = emptyList(),
            callSiteKey = devstudioai.lang.kotlin.interp.CallSiteKey(7), source = span,
        )
    ...
    fun composeDispatcherReordersNamedArguments() {
        ...
        fun arg(name: String, v: Any?) =
            devstudioai.lang.kotlin.interp.RArg(devstudioai.lang.kotlin.interp.RNode.Const(v, null, span), name)
        val callee = devstudioai.lang.kotlin.interp.ResolvedCallable.Library(
            displayName = "RecordValues", ownerFqn = facade, methodName = "RecordValues",
            paramTypes = listOf(
                devstudioai.lang.kotlin.symbols.KotlinType("kotlin.String"),
        ...
        val call = devstudioai.lang.kotlin.interp.RNode.Call(
            callee, devstudioai.lang.kotlin.interp.DispatchKind.TOP_LEVEL, receiver = null,
            args = listOf(arg("flag", false), arg("label", "named")),
            callSiteKey = devstudioai.lang.kotlin.interp.CallSiteKey(9), source = span,
        )
        val dispatcher = ComposeDispatcher()
        composeOnce {
            dispatcher.composer = currentComposer
    ...
    fun composableMemberCallOnAnObjectThreadsTheComposer() {
        ...
        val facade = "devstudioai.interp.compose.Defaults"
        val span = devstudioai.lang.kotlin.interp.SourceSpan(0, 0)
        fun arg(name: String, v: Any?) =
            devstudioai.lang.kotlin.interp.RArg(devstudioai.lang.kotlin.interp.RNode.Const(v, null, span), name)
        val callee = devstudioai.lang.kotlin.interp.ResolvedCallable.Library(
        ...
        val call = devstudioai.lang.kotlin.interp.RNode.Call(
            callee, devstudioai.lang.kotlin.interp.DispatchKind.MEMBER, receiver = null,
            args = listOf(arg("content", "C")), // omit the leading `container` default
            callSiteKey = devstudioai.lang.kotlin.interp.CallSiteKey(11), source = span,
        )
        val dispatcher = ComposeDispatcher()
        var result: Any? = null
        composeOnce {
    ...
    fun extensionComposableThreadsTheComposerWithReceiverAsFirstParam() {
        ...
        val call = devstudioai.lang.kotlin.interp.RNode.Call(
            callee, devstudioai.lang.kotlin.interp.DispatchKind.EXTENSION, receiver = null,
            args = listOf(devstudioai.lang.kotlin.interp.RArg(devstudioai.lang.kotlin.interp.RNode.Const(true, null, span))),
            callSiteKey = devstudioai.lang.kotlin.interp.CallSiteKey(13), source = span,
        )
        val dispatcher = ComposeDispatcher()
        composeOnce {
            dispatcher.composer = currentComposer
    ...
    fun previewRenderErrorIsCaughtAndReportedNotThrown() {
        ...
        val call = devstudioai.lang.kotlin.interp.RNode.Call(
            callee, devstudioai.lang.kotlin.interp.DispatchKind.TOP_LEVEL, receiver = null, args = emptyList(),
            callSiteKey = devstudioai.lang.kotlin.interp.CallSiteKey(0), source = span,
        )
        val body = devstudioai.lang.kotlin.interp.RNode.Block(listOf(call), isExpression = false, source = span)
        val entry = devstudioai.lang.kotlin.interp.ResolvedFunction("Boom", emptyList(), body, emptyList())
    ...
    fun inParensLambdaArgBindsPositionallyNotToTheLastParam() {
        ...
        fun arg(name: String, v: devstudioai.lang.kotlin.interp.RNode) = devstudioai.lang.kotlin.interp.RArg(v, name, false, false)
        val callee = devstudioai.lang.kotlin.interp.ResolvedCallable.Library(
            displayName = "Toggle", ownerFqn = facade, methodName = "Toggle",
            paramTypes = listOf(
                devstudioai.lang.kotlin.symbols.KotlinType("kotlin.Boolean"),
                devstudioai.lang.kotlin.symbols.KotlinType("kotlin.Function1"),
                devstudioai.lang.kotlin.symbols.KotlinType("devstudioai.interp.compose.ToggleSource"),
            ),
            isStatic = true, isConstructor = false, isInline = false, isComposable = true,
        ...
        val call = devstudioai.lang.kotlin.interp.RNode.Call(
            callee, devstudioai.lang.kotlin.interp.DispatchKind.TOP_LEVEL, receiver = null,
            args = listOf(arg("checked", devstudioai.lang.kotlin.interp.RNode.Const(true, null, span)), arg("onChange", devstudioai.lang.kotlin.interp.RNode.Const(null, null, span))),
            callSiteKey = devstudioai.lang.kotlin.interp.CallSiteKey(21), source = span,
        )
        val dispatcher = ComposeDispatcher()
        composeOnce {
            dispatcher.composer = currentComposer
    ...
    private fun anyProxy(lambda: devstudioai.interp.InterpretedLambda, fi: Class<*>): Any =
    ...
    fun constructorOmittingDefaultedValueClassParamsRoutesThroughTheInitDefaultSynthetic() {
        ...
        val call = devstudioai.lang.kotlin.interp.RNode.Call(
            callee, devstudioai.lang.kotlin.interp.DispatchKind.CONSTRUCTOR, receiver = null,
            args = listOf(devstudioai.lang.kotlin.interp.RArg(devstudioai.lang.kotlin.interp.RNode.Const("custom", null, span), name = "name")),
            callSiteKey = devstudioai.lang.kotlin.interp.CallSiteKey(31), source = span,
        )
    ...
    fun constructorAcceptsAnUnboxedValueClassArgAndDefaultsAnOmittedMiddleParam() {
        ...
        val call = devstudioai.lang.kotlin.interp.RNode.Call(
            ...
            callSiteKey = devstudioai.lang.kotlin.interp.CallSiteKey(33), source = span,
        )
    ...
    fun constructorBoxesAnUnboxedValueClassArgForANullableValueClassParam() {
        ...
        val call = devstudioai.lang.kotlin.interp.RNode.Call(
            callee, devstudioai.lang.kotlin.interp.DispatchKind.CONSTRUCTOR, receiver = null,
            args = listOf(devstudioai.lang.kotlin.interp.RArg(devstudioai.lang.kotlin.interp.RNode.Const(0x0000FFL, null, span), name = "tint")),
            callSiteKey = devstudioai.lang.kotlin.interp.CallSiteKey(35), source = span,
        )
