package devstudioai.preview.realview
...
import devstudioai.preview.impl.RealViewRequest
import devstudioai.preview.impl.RealViewResult
import devstudioai.preview.impl.RealViewRuntime
import java.io.File
...
class AndroidRealViewRuntime(
    ...
    private fun classpathSig(classpath: List<Path>): String {
        ...
        val hashes = devstudioai.android.support.tasks.SharedLibraryDexer.contentHashes(jars, hashCacheDir.toPath())
    ...
    private fun mergedLibraryDex(root: File, libJars: List<Path>, minApi: Int, librarySig: String, notify: ((String) -> Unit)?): File? {
        ...
        if (!fresh) {
            ...
            val libDexer = devstudioai.android.support.tasks.SharedLibraryDexer(
