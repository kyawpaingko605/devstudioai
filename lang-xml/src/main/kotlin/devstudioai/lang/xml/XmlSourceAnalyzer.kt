...
import devstudioai.lang.xml.completion.XmlCompletionContributor
import devstudioai.lang.xml.completion.XmlCompletion
...
class XmlSourceAnalyzer : SourceAnalyzer {
    ...
    @Volatile var inlayResourceResolver: devstudioai.lang.xml.hints.XmlResourceValueResolver? = null
    ...
    override val semanticHighlighter = devstudioai.lang.xml.highlight.XmlSemanticHighlighter(::parsedFile)

    /** Inlay hints (resolved resource-value previews) are available only once the host wires the resolver. */
    override val inlayHints: devstudioai.lang.hints.InlayHintService?
        get() = inlayResourceResolver?.let { devstudioai.lang.xml.hints.XmlInlayHintService(::parsedFile, it) }
