...
import devstudioai.lang.xml.completion.XmlContextScanner
...
class XmlCompletionTest {
    ...
    fun matchesAttributeLocalNameWithoutNamespacePrefix() = runTest {
        ...
        val contributor = devstudioai.lang.xml.completion.XmlCompletionContributor {
    ...
    fun serviceMergesAndPrefixFiltersContributors() = runTest {
        val contributor = devstudioai.lang.xml.completion.XmlCompletionContributor { p ->
