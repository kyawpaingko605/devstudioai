...
import devstudioai.lang.kotlin.interp.RArg
...
class StaticMemberAccessTest {
    ...
    fun kotlinObjectReceiverStillGoesThroughItsInstance() {
        ...
        val get = RNode.PropertyGet(objRef("devstudioai.interp.Vault", "Vault"), Binding.Property("balance", null, backingField = false), span)
    ...
    fun nestedObjectReadThroughEnclosingObject() {
        ...
        val get = RNode.PropertyGet(objRef("devstudioai.interp.IconsLike", "IconsLike"), Binding.Property("AutoMirrored", null, backingField = false), span)
    ...
    fun deeplyNestedObjectReadThroughInstance() {
        ...
        val autoMirrored = RNode.PropertyGet(objRef("devstudioai.interp.IconsLike", "IconsLike"), Binding.Property("AutoMirrored", null, backingField = false), span)
