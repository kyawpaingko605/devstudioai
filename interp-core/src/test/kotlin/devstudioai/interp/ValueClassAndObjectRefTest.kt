package devstudioai.interp

import devstudioai.lang.kotlin.interp.Binding
import devstudioai.lang.kotlin.interp.CallSiteKey
import devstudioai.lang.kotlin.interp.DispatchKind
import devstudioai.lang.kotlin.interp.RNode
import devstudioai.lang.kotlin.interp.ResolvedCallable
import devstudioai.lang.kotlin.interp.ResolvedFunction
import devstudioai.lang.kotlin.interp.SourceSpan
...
class ValueClassAndObjectRefTest {
    ...
    fun bareObjectReferenceMaterializesTheSingleton() {
        val node = RNode.Name(Binding.ObjectRef("devstudioai.interp.Vault", "Vault"), span)
    ...
    fun valueClassPropertyGetterIsFoundDespiteMangling() {
        ...
        val recv = RNode.Name(Binding.ObjectRef("devstudioai.interp.Vault", "Vault"), span)
    ...
    fun valueClassParamCallIsFoundDespiteMangling() {
        ...
        val callee = ResolvedCallable.Library(
            displayName = "spend", ownerFqn = "devstudioai.interp.ValueClassAndObjectRefTestKt", methodName = "spend",
    ...
    private fun arg(value: Any?) = devstudioai.lang.kotlin.interp.RArg(RNode.Const(value, null, span))
    ...
    fun extensionDefaultParamMaskExcludesTheReceiver() {
        ...
        val callee = ResolvedCallable.Library(
            displayName = "scaled", ownerFqn = "devstudioai.interp.ValueClassAndObjectRefTestKt", methodName = "scaled",
    ...
    private val facade = "devstudioai.interp.ValueClassAndObjectRefTestKt"

    private fun lib(name: String) = ResolvedCallable.Library(
        displayName = name, ownerFqn = "devstudioai.interp.ValueClassAndObjectRefTestKt", methodName = name,
        paramTypes = emptyList(), isStatic = true, isConstructor = false, isInline = false, descriptorPrecise = true,
    )
}
