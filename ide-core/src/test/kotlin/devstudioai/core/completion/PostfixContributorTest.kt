...
import devstudioai.lang.postfix.POSTFIX_TEMPLATE_EP
import devstudioai.lang.postfix.PostfixContext
import devstudioai.lang.postfix.PostfixExpansion
import devstudioai.lang.postfix.PostfixTemplate
...
import devstudioai.platform.impl.ExtensionRegistryImpl
...
class PostfixContributorTest {
    ...
    fun typeGatedTemplateRespectsReceiverType() {
        val boolType = object : TypeRef {
            ...
            override fun members(accessibleFrom: devstudioai.lang.resolve.Symbol?) = emptyList<devstudioai.lang.resolve.Symbol>()
        }
    ...
    private class Parsed(private val txt: String) : ParsedFile {
        ...
        override val diagnostics = emptyList<devstudioai.lang.dom.Diagnostic>()
