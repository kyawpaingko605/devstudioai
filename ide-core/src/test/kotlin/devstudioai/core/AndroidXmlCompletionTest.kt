...
class AndroidXmlCompletionTest {
    ...
    fun completesCustomViewTagsFromLibrariesByFqnAndSimpleName() {
        val views = listOf(
            devstudioai.android.support.metadata.Widget("com.google.android.material.button.MaterialButton", false),
            devstudioai.android.support.metadata.Widget("androidx.constraintlayout.widget.ConstraintLayout", true),
        )
        val svc = XmlCompletion(contributors = {
