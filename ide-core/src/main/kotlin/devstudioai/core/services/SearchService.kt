...
import devstudioai.ui.backend.UiSearchOptions
import devstudioai.ui.backend.UiTextMatch
 ...
 * Carved out of [devstudioai.core.IdeServices].
 *
 * The [indexService][devstudioai.index.IndexService] it queries stays shared infrastructure (completion/analysis/
