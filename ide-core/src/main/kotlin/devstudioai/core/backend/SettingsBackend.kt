...
import devstudioai.core.completion.CompletionOptions
import devstudioai.core.settings.BuiltInSettingsPages
import devstudioai.core.settings.CodeStyleSettings
import devstudioai.core.settings.IdeSettings
import devstudioai.core.settings.SettingsStore
import devstudioai.lang.dom.Severity
import devstudioai.platform.settings.PreferenceReader
import devstudioai.platform.settings.SettingControl
import devstudioai.platform.settings.SettingsPage
import devstudioai.platform.settings.SettingsScope
import devstudioai.ui.backend.SettingsService
import devstudioai.ui.backend.UiAccent
import devstudioai.ui.backend.UiCodeStyle
import devstudioai.ui.backend.UiInspection
import devstudioai.ui.backend.UiSeverity
import devstudioai.ui.backend.UiSettingControl
import devstudioai.ui.backend.UiSettings
import devstudioai.ui.backend.UiSettingsPage
...
internal class SettingsBackend(private val ctx: BackendContext) : SettingsService {
    ...
    private fun parseConflictPolicy(value: String?): devstudioai.deps.ConflictPolicy = when (value) {
        BuiltInSettingsPages.CONFLICT_PINNED -> devstudioai.deps.ConflictPolicy.PINNED
        BuiltInSettingsPages.CONFLICT_FAIL -> devstudioai.deps.ConflictPolicy.FAIL_ON_CONFLICT
        else -> devstudioai.deps.ConflictPolicy.NEWEST
    }
