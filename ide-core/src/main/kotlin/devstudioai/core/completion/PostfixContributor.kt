 ...
 * surfaces each applicable [devstudioai.lang.postfix.PostfixTemplate] as a `kind = SNIPPET` item.
 *
 * Convention for the generic path (documented here since the EP shipped interfaces-only): a template's
 * [PostfixExpansion.snippet][devstudioai.lang.postfix.PostfixExpansion.snippet] IS the rewrite text (with tab
 ...
 * [PostfixExpansion.edits][devstudioai.lang.postfix.PostfixExpansion.edits] are any *extra* edits (imports, …).
 *
