package devstudioai.core.completion

import devstudioai.lang.completion.BasicCompletionResultSet
import devstudioai.lang.completion.COMPLETION_CONTRIBUTOR_EP
import devstudioai.lang.completion.COMPLETION_WEIGHER_EP
...
import devstudioai.lang.completion.CompletionWeigher
 ...
 * [devstudioai.lang.SourceAnalyzer.completionContributions], plus every cross-cutting / plugin contributor from
...
class CompletionEngine(private val extensions: ExtensionRegistry) {
     ...
     * backend exposes ([devstudioai.lang.SourceAnalyzer.completionContributions]). They are merged into the same run
