package devstudioai.core.actions

import devstudioai.core.ApplicationEnvironment
...
/**
 * The host's built-in [devstudioai.plugin.action.IdeAction]s — pure engine commands surfaced through the action
