 ...
 *
 * This is the keystone of the [devstudioai.ui.backend.IdeBackend] decomposition: as later concern services are
...
internal interface EngineContext {
    ...
    fun buildAnalyzer(module: Module, language: devstudioai.lang.LanguageId): devstudioai.lang.SourceAnalyzer
    ...
    fun resourceRepo(module: Module): devstudioai.android.support.resources.ResourceRepository?
