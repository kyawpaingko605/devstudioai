package devstudioai.android.support.templates

import devstudioai.android.support.AndroidFacet
import devstudioai.android.support.BuildFeatures
...
import devstudioai.model.template.TemplateDependency
...
object JetpackComposeAppTemplate : ProjectTemplate {
    ...
    override fun dependencies(args: TemplateArgs): List<TemplateDependency> =
        devstudioai.android.support.AndroidFeatureDependencies.COMPOSE.map { TemplateDependency("app", it) }
