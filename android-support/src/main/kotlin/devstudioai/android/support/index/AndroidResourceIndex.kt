package devstudioai.android.support.index
 ...
 *
 * The project's OWN `res/` roots are fed via [devstudioai.index.IndexScope.resourceRoots] (the in-memory source
 * side, edit-sensitive); immutable dependency/AAR `res/` is content-addressed onto disk segments via
 * [devstudioai.index.IndexScope.libraryResourceRoots] - so the bulk of a Material/AndroidX resource set is parsed
