...
import devstudioai.android.support.resources.RIdAssignment
import devstudioai.android.support.resources.ResourceModel
 ...
 * module's merged [devstudioai.android.support.resources.ResourceRepository] (its own `res/` plus its android-lib
...
class AndroidRClassProvider(
    ...
    private fun styleableClass(namespace: String, repo: devstudioai.android.support.resources.ResourceRepository, ids: RIdAssignment): SyntheticClass {
