...
object SampleAndroidProject {
    ...
    fun generate(
        ...
        write(store, "app/src/main/res/values/themes.xml", devstudioai.android.support.templates.AndroidAppAssets.themesXml)
        write(store, "app/src/main/res/values-night/themes.xml", devstudioai.android.support.templates.AndroidAppAssets.themesNightXml)
        write(store, "app/src/main/res/values/attrs.xml", APP_ATTRS)
        write(store, "app/src/main/res/layout/activity_main.xml", APP_LAYOUT)
        for ((rel, content) in devstudioai.android.support.templates.AndroidAppAssets.launcherIconResFiles) {
