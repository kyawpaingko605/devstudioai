package devstudioai.vfs.local

import devstudioai.platform.ContentHash
import devstudioai.vfs.FileWatch
import devstudioai.vfs.VirtualFile
import devstudioai.vfs.VirtualFileSystem
 ...
 * only on the `devstudioai.vfs` interfaces, it can be swapped in without touching the model.
 *
