...
// Pinned package + non-public so it stays an internal `devstudioai.ui` detail the theme reads.
compose.resources {
    publicResClass = false
    packageOfResClass = "devstudioai.ui.generated.resources"
