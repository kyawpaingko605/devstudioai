...
import devstudioai.ui.editor.core.EditSpan
 ...
 */
fun shiftFoldRegions(regions: List<devstudioai.ui.editor.folding.FoldRegion>, edit: EditSpan, docLength: Int): List<devstudioai.ui.editor.folding.FoldRegion> {
    if (regions.isEmpty() || edit.isNoOp) return regions
    val out = ArrayList<devstudioai.ui.editor.folding.FoldRegion>(regions.size)
    for (r in regions) {
