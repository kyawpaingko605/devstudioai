 ...
 * the [devstudioai.ui.editor.folding.FoldModel]'s one-row-per-visible-line mapping; when wrapping, a line spans
...
internal fun DrawScope.drawEditor(
    ...
    foldModel: devstudioai.ui.editor.folding.FoldModel,
    vlayout: VLayout,
    wrap: Boolean,
    ...
    structure: List<devstudioai.ui.backend.UiFileSymbol>,
...
internal fun stickyHeaderItems(
    ...
    doc: devstudioai.ui.editor.core.EditorDocument,
    max: Int,
): List<devstudioai.ui.backend.UiFileSymbol> {
