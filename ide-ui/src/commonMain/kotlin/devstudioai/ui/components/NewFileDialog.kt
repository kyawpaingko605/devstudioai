 ...
 * Java dialog (so [devstudioai.ui.AppState.createFile] refreshes the tree + opens it).
 */
 ...
 * [devstudioai.ui.AppState.addSourceRoot] places it at `src/<set>/<dirName>` and refreshes the tree.
 */
@Composable
